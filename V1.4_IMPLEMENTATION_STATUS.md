...
## ✅ Core Stability Features (COMPLETED)

### 1. Deterministic Forecast Mode (DFM) ✅
...
### 2. Forecast Stability Smoothing ✅
...
### 4. Chronos Input Pipeline Hardening ✅
- **File:** `models/tsfm/forecast_utils.py` (updated)
- **Status:** Implemented
- **Features:**
  - Strict ordering enforcement
  - Deterministic numpy→torch casting (float64)
...
### New Controls Added:
- ✅ Deterministic Mode (DFM) checkbox
- ✅ Stability Smoothing toggle
- ✅ Date Anchoring toggle
- ✅ Position Sizing display

### Features Available:
- Deterministic forecasts (same inputs → same outputs)
